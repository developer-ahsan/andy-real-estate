...
import { royalitiesRoutes } from './royalities.routing';

@NgModule({
    declarations: [
        RoyaltyComponent,
        LicensingCompaniesComponent,
        RoyaltyReportsComponent,
        RoyaltySettingsComponent,
    ],
    imports: [
        RouterModule.forChild(royalitiesRoutes),
        MatButtonModule,
        MatCheckboxModule,
        MatFormFieldModule,
        MatIconModule,
