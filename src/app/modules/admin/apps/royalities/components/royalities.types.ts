...
export interface createLicensingCompany { name: string; create_licensing_company: boolean; };
export interface deleteLicensingCompany { licensing_id: number; delete_licensing_company: boolean; };
