...
export class InventoryService {
    ...
    public adminUserPermissions = {
        addDefaultProductImage: false,
        addProduct: false,
        addProductComment: false,
        addProductTag: false,
        addRapidBuild: false,
        addToCore: false,
        addToRapidBuild: false,
        deleteProduct: false,
        duplicateProduct: false,
        exportProducts: false,
        newProductDetails: false,
        newProductMarket: false,
        newProductRequest1: false,
        newProductRequest2: false,
        newProductRequest3: false,
        newProductRequest4: false,
        newProductType: false,
        productDashboard: false,
        productDiscontinueRequest: false,
        removeCoreProduct: false,
        removeDefaultProductImage: false,
        removeProductComment: false,
        selectCompanyProduct: false,
        selectProduct: false,
        selectProductByKeywords: false,
        submitNewProductRequest: false,
        updateActiveStatus: false,
        updateArtworkTemplate: false,
        updateCoreStatus: false,
        updateCost: false,
        updateDefaultMargins: false,
        updateLicensingTerms: false,
        updateProductTag: false,
        updateProductVideo: false,
        updateSkipExpressStatus: false,
        updateSwatches: false,
        updateWarehouseOptions: false,
        uploadArtworkTemplate: false,
        viewAddRapidBuild: false,
        viewArtworkTemplate: false,
        viewComments: false,
        viewCoreOptions: false,
        viewCost: false,
        viewDefaultImages: false,
        viewDefaultMargins: false,
        viewDeleteProduct: false,
        viewDiscontinued: false,
        viewDuplicate: false,
        viewLicensingTerms: false,
        viewOrderHistory: false,
        viewProductReviews: false,
        viewProductStatus: false,
        viewProductTags: false,
        viewProductVideo: false,
        viewSwatches: false,
        viewUpdateHistory: false,
        viewWarehouseOptions: false
    };
    public productDescription = {
        assignExistingAttributes: false,
        assignNewAttribute: false,
        removeAttributes: false,
        searchAttributes: false,
        updateAttributes: false,
        updateCaseDimensions: false,
        updateCaseQuantities: false,
        updateDescription: false,
        updateDietaryInfo: false,
        updateFlatRateShipping: false,
        updatePhysics: false,
        updateProductQuote: false,
        viewAttributes: false,
        viewDescription: false,
        viewDietaryInfo: false,
        viewPhysics: false,
        viewProductQuote: false,
    };
    public productImprint = {
        addDuplicateImprint: false,
        addImprint: false,
        addStandardApparelImprints: false,
        addStandardImprints: false,
        deleteImprint: false,
        modifyImprint: false,
        newImprint: false,
        removeAllImprints: false,
        selectImprint: false,
        selectTestImprints: false,
        updateGroupRun: false,
        updateImprint: false,
        updateImprintDisplayOrder: false,
        updateIncludables: false,
        updateOverlaps: false,
        viewDuplicateImprint: false,
        viewImprint: false,
        viewImprintDisplayOrder: false,
        viewIncludables: false,
        viewOverlaps: false,
        viewTestImprintsPricing: false,
    };
    public productOption = {
        addNewColors: false,
        addNewPackagings: false,
        updateChart: false,
        updateColors: false,
        updateNewColors: false,
        updateOptionsPricingCorrection: false,
        updatePackagings: false,
        updateQuickColors: false,
        updateSizes: false,
        viewColors: false,
        viewNewColors: false,
        viewOptionsPricingCorrection: false,
        viewPackagings: false,
        viewQuickColors: false,
        viewSizes: false,
    };
    public storeProduct = {
        addStoreProduct: false,
        addStoreProductReview: false,
        addStoreProductReviewResponse: false,
        addToRapidBuild: false,
        addVirtualProof: false,
        applyStoreProductCoop: false,
        exportStoreProducts: false,
        removeProduct: false,
        removeStoreProductReviewResponse: false,
        removeVirtualProof: false,
        reviewAutoSubmit: false,
        selectStoreProduct: false,
        sendProductReview: false,
        updateMargins: false,
        updatePermalink: false,
        updateRapidBuildID: false,
        updateRoyaltySettings: false,
        updateShippingOptions: false,
        updateStatus: false,
        updateStoreProductVideo: false,
        updateWarehouseOptions: false,
        viewNewStoreProductReview: false,
        viewPermalink: false,
        viewPricing: false,
        viewProfitCalculator: false,
        viewRapidBuildID: false,
        viewRemove: false,
        viewRoyaltySettings: false,
        viewSendProductReview: false,
        viewShippingOptions: false,
        viewStatus: false,
        viewStoreProductCoop: false,
        viewStoreProductReviews: false,
        viewStoreProductUpdateHistory: false,
        viewStoreProductVideo: false,
        viewVirtualProofs: false,
        viewWarehouseOptions: false,
    };
