...
@Component({
  selector: 'app-product-migrations',
  templateUrl: './product-migrations.component.html',
  styles: [".mat-paginator {border-radius: 16px !important}"]
})
export class ProductMigrationsComponent implements OnInit, OnDestroy {
