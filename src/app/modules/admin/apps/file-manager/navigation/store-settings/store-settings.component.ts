...
export class StoreSettingsComponent implements OnInit, OnDestroy {
  ...
  saveChanges(): void {
    ...
    const payload = {
      ...
      store_code: formValues.storeCode,
      store_url: formValues.storeURL,
      store_description: formValues.metaDesc,
      ...
      google_tag: formValues.googleTag,
      bing_tag: formValues.bingTag,
      ...
      product_builder_text: formValues.productBuilderText,
