...
export class FileManagerService {
  ...
  public store = {
    addArtApprovalContact: false,
    addCostCenterCode: false,
    addReferralLocation: false,
    addStore: false,
    addStoreProductReviewResponse: false,
    addStudentOrg: false,
    addSurvey: false,
    addSurveyHeader: false,
    applyBlanketCreditTerms: false,
    automateSurvey: false,
    blanketCreditTerms: false,
    bulkRapidBuildActions: false,
    createAdditionalProofEmail: false,
    createFulfillmentContact: false,
    createRoyalty: false,
    createStoreOptInDataFile: false,
    createStorePlan: false,
    createStoreUserDataFile: false,
    dashboard: false,
    editAdditionalProofEmail: false,
    editReviewedProducts: false,
    editStoreInventory: false,
    editSurvey: false,
    exportReviews: false,
    finalizeConsolidatedBill: false,
    finalizeSurvey: false,
    generateStoreProductDataFile: false,
    hideSurvey: false,
    importStudentOrgData: false,
    newStore: false,
    newStorePlan: false,
    rapidBuildImageDashboard: false,
    rapidBuildImageDetails: false,
    reloadStore: false,
    removeRapidBuildEntry: false,
    removeStoreProductReviewResponse: false,
    removeSurvey: false,
    removeSurveyHeader: false,
    removeUncategorized: false,
    resendFulfillmentInvoice: false,
    resetTopTen: false,
    router: false,
    royalties: false,
    selectConsolidatedBillRange: false,
    selectImageManagementMarket: false,
    selectProcurementReport: false,
    selectProduct: false,
    selectRoyaltyReport: false,
    selectStore: false,
    submitStorePlan: false,
    updateAdditionalProofEmail: false,
    updateArtApprovalContact: false,
    updateArtApprovalSetting: false,
    updateCampusEmail: false,
    updateCostCenterCode: false,
    updateFulfillmentContact: false,
    updateFulfillmentInvoice: false,
    updateFulfillmentOptions: false,
    updateGroupBuySettings: false,
    updateJaggaerSettings: false,
    updateMarginGroup: false,
    updateMargins: false,
    updateRapidBuildProof: false,
    updateReferralLocation: false,
    updateReview: false,
    updateRoyalties: false,
    updateRoyalty: false,
    updateRoyaltyCopy: false,
    updateShippingNotification: false,
    updateStore: false,
    updateStoreApparelDecorator: false,
    updateStoreInventory: false,
    updateStorePlan: false,
    updateStoreVendorTags: false,
    updateStudentOrgs: false,
    uploadImageManagementImage: false,
    viewArtApprovalContacts: false,
    viewArtApprovalGroups: false,
    viewArtApprovalGroups2: false,
    viewBulkRapidBuildActions: false,
    viewConsolidatedBill: false,
    viewCostCenterCodes: false,
    viewEditSurvey: false,
    viewExportReviews: false,
    viewFulfillmentContact: false,
    viewFulfillmentContacts: false,
    viewFulfillmentInvoice: false,
    viewFulfillmentInvoices: false,
    viewFulfillmentOptions: false,
    viewGroupBuySettings: false,
    viewHiddenSurveys: false,
    viewImageManagementProducts: false,
    viewImageManagementUpload: false,
    viewJaggaerSettings: false,
    viewLocationRoyaltyReport: false,
    viewMarginGroupProducts: false,
    viewMargins: false,
    viewOfflineProducts: false,
    viewOptInUserDataFile: false,
    viewProcurementReport: false,
    viewReferralLocations: false,
    viewReloadStore: false,
    viewResetTopTen: false,
    viewReviewedProducts: false,
    viewRoyaltySettings: false,
    viewSearchHistory: false,
    viewSearchKeywords: false,
    viewShippingNotification: false,
    viewStore: false,
    viewStoreApparelDecorator: false,
    viewStoreInventory: false,
    viewStorePlan: false,
    viewStorePlans: false,
    viewStoreProductSupplier: false,
    viewStoreRoyaltyReport: false,
    viewStoreUserDataFile: false,
    viewStoreVendorTags: false,
    viewStoreVideos: false,
    viewStudentOrgs: false,
    viewSuppliers: false,
    viewSurveyAnalytics: false,
    viewSurveys: false,
    viewTopTen: false,
    viewWarehouseContact: false,
    viewWarehouseInvoices: false,
  };
