...
export class FileManagerService {
  ...
  public store = {
    ...
    addCollection: false,
    addCompany: false,
    addCompanyComment: false,
    addCompanyTag: false,
    addCoop: false,
    addFOBLocation: false,
    addVendorUser: false,
    applyBlanketCollection: false,
    applyBlanketFOB: false,
    applyBlanketRun: false,
    applyBlanketSetup: false,
    applyCompanyWideCoop: false,
    confirmRemoveFOBLocation: false,
    deleteChart: false,
    deleteCollection: false,
    deleteCoop: false,
    editCoop: false,
    generateExcelSalesReport: false,
    imageDashboard: false,
    imageDetails: false,
    listProducts: false,
    newCollection: false,
    newCompany: false,
    newCoop: false,
    newVendorUser: false,
    removeAllVendorVideos: false,
    removeVendorUser: false,
    searchCompanyByKeyword: false,
    selectCompany: false,
    selectDefaultImageProduct: false,
    selectProduct: false,
    selectProductByID: false,
    selectProductByKeyword: false,
    selectProductByUpdate: false,
    sendEmails: false,
    submitSupplierApplication: false,
    updateChart: false,
    updateCollection: false,
    updateCompany: false,
    updateCompanyTags: false,
    updateCoop: false,
    updateDesignerNotes: false,
    updateFOBLocation: false,
    updateProfile: false,
    updateProof: false,
    updateSupplierApplication: false,
    updateSupplierUser: false,
    updateVendorStatus: false,
    updateVendorUser: false,
    updateWebsiteInfo: false,
    viewBlanketCollection: false,
    viewBlanketFOB: false,
    viewBlanketRun: false,
    viewBlanketSetup: false,
    viewCharts: false,
    viewCollection: false,
    viewCollectionImprints: false,
    viewCollections: false,
    viewCompany: false,
    viewCompanyComments: false,
    viewCompanyOrders: false,
    viewCompanyTags: false,
    viewCompanyWideCoop: false,
    viewCoops: false,
    viewCoreProducts: false,
    viewDesignerNotes: false,
    viewDisabledVendors: false,
    viewFOBLocations: false,
    viewOpenPOs: false,
    viewProductListFile: false,
    viewProfile: false,
    viewSendEmails: false,
    viewSupplierApplication: false,
    viewSupplierApplication2: false,
    viewTopProducts: false,
    viewTopTenProducts: false,
    viewVendorDataFile: false,
    viewVendorStatus: false,
    viewVendorUser: false,
    viewVendorUsers: false,
    viewVendorVideos: false
  };
